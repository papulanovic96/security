...
import com.megatravel.entity.CertificatesAndKeyHolder;
...
import com.megatravel.repository.CertificateRepository;
import com.megatravel.storage.CertificateStorage;
...
public class CertificateServiceImpl implements CertificateService {
    ...
    public Certificate createRootCertificate(String subject) {
        ...
        try {
        	...
        	DNSName dnsName = new DNSName("www.megatravel.com");
            ...
            exts.set(san.getExtensionId().toString(), san);
